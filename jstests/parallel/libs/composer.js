load('jstests/parallel/libs/pfsm.js');

var composer = (function() {

    function runCombinedFSM(workloads, configs, mixProb) {
        // TODO: what if a workload depends on iterations?
        // TODO: what if a workload depends on threadCount?

        var iterations = 100;

        // TODO: set globalAssertLevel to ALWAYS
        ...
        for (var i = 0; i < iterations; ++i) {
            ...
            if (Random.rand() >= mixProb) {
                var nextState = pfsm._getWeightedRandomChoice(args.transitions[currentState],
                                                              Random.rand());
