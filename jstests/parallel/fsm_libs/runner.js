...
var runner = (function() {
    ...
    function validateExecutionOptions(mode, options) {
        ...
        if (typeof options.subsetSize !== 'undefined') {
            ...
            assert.gt(options.subsetSize, 0);
        ...
        if (typeof options.composeProb !== 'undefined') {
            ...
            assert.gte(options.composeProb, 0);
    ...
    function dropCollections(workloads, context, cluster, clusterOptions) {
        // If no other workloads will be using this collection,
        // then drop it to avoid having too many files opens
        ...
        try {
            ...
            schedule.forEach(function(workloads) {
                ...
                if (!errors.length && !teardownFailed) {
                    dropCollections(workloads, context, cluster, clusterOptions);
                }
